...
import "package:babylon_app/legacy/views/chat/create_new_chat.dart";
...
import "package:babylon_app/legacy/views/chat/search_groupchat.dart";
      ...
      leading: InkWell(
        onTap: () async {
          if (chat.adminUID == null || chat.adminUID == "") {
            ...
            final BabylonUser? otherUser =
                await UserService.getBabylonUser(userUID: otherUserUID);
            if (otherUser != null) {
              Navigator.push(
                context,
                MaterialPageRoute(
